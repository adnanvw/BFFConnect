...
import AddBFFConnect from "../Components/AddBFFConnect.js";
...
function Home() {
  ...
  const [BFFConnect, setBFFConnect] = useState();
  ...
  return (
    <div className="home">
      {/* Chat Adding Card */}
      <AddBFFConnect addchattoggler={() => { addchatToggler(); }} addchattoggle={addtoggle} />
            ...
            <>
              <div className="chatroom-header">
                <div className="chatroom-chatinfo">
                  <img className='BFFConnectnnectnnectnnectnnect-profilepic' src={BFFConnect?.photo ? API_URL + "photo/" + BFFConnect?.photo : "assets/noavatar.jpg"} alt='' />

                  <div className="chatroom-chatinfo-right">
                    <div className="chatroom-chatinfo-name">
                      <p>{BFFConnect?.username}</p>
                    </div>
                  </div>
                </div>
              </div>
